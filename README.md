...
The full pipeline from preprocessing, prediction to demo UI—is **containerized and deployed automatically** using a CI/CD workflow with **GitHub Actions**, **Docker**, and **Google Cloud Run**.
