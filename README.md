...
|                              | `cnn_frame_extractor.py`      | Script version of the frame extraction process.                            |
...
|                              | `test_sanity.py`              | Runs sanity checks on preprocessed data and labels.                        |
...
|                              | `evaluate.py`                 | Runs evaluation on test data and outputs predictions.                      |
|                              | `evaluate.ipynb`              | Notebook version of the evaluation pipeline.                               |
|                              | `generate_demo.py`            | Builds demo videos with overlaid predictions.                              |
|                              | `generate_demo.ipynb`         | Interactive notebook version for demo generation.                          |
